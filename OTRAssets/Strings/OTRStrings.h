...
#define UPSCHAT_PUSH_STRING [OTRLanguageManager translatedString: @"UPS Chat Push Notifications"]
...
#define PASSWORD_CONFIRM_STRING [OTRLanguageManager translatedString: @"Password Confirm"]
...
#define RECEIVED_STRING [OTRLanguageManager translatedString: @"Received"]
...
#define ONBOARDING_SUCCESS_STRING [OTRLanguageManager translatedString: @"You're ready to use"]
...
#define WANTS_TO_CHAT_STRING [OTRLanguageManager translatedString: @"wants to chat."]
...
#define FIRSTNAME_STRING [OTRLanguageManager translatedString: @"First Name"]
#define LASTNAME_STRING [OTRLanguageManager translatedString: @"Last Name"]
...
#define GROUP_NAME_STRING [OTRLanguageManager translatedString: @"Group Name"]
...
#define PUSH_TITLE_STRING [OTRLanguageManager translatedString: @"Push Notification"]
...
#define KNOCK_STRING [OTRLanguageManager translatedString: @"Knock"]
...
#define INVITE_LINK_STRING [OTRLanguageManager translatedString: @"Share Invite"]
...
#define SOMEONE_STRING [OTRLanguageManager translatedString: @"Someone"]
